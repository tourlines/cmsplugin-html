...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'cmsplugin_javascript_carouselpluginmodel', (
            ...
            ('indicador', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('altura', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('largura', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
            ('velocidade', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=6000, blank=True)),
        ))
        db.send_create_signal(u'cmsplugin_javascript', ['CarouselPluginModel'])


    def backwards(self, orm):
        # Deleting model 'CarouselPluginModel'
        db.delete_table(u'cmsplugin_javascript_carouselpluginmodel')
